...
### UX / Navigation
- [ ] **Remove swipe-to-delete entirely** — bad discoverability, easy to trigger accidentally while scrolling, no visual hint it exists; delete moves exclusively to the long-press context menu
